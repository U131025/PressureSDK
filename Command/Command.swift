...
public enum WLSendCommandType {
    case realTime
    case sysn(WLSettingModel, WLSettingModel)
    case voicePrompt
...
//            let model = SettingModel.recover(.pressure)
...
//            let model = SettingModel.recover(.intelligent)
...
/// 加压模式
public class WLKGModel: WLBaseModel {
...
public class WLGroupModel: WLBaseModel {
